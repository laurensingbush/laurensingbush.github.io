const projectDetails = [
  {
    ...
    description:
      "A web app for easily finding new hobbies to enjoy in your leisure time. Sign in via GitHub or Google to keep track of your current hobbies and new hobbies you'd like to try. ",
    technologies: [
      "Next.js",
      "SCSS",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "A web app for searching movies and shows. Create and save a list of your favorites to view whenever you're logged in.",
    technologies: [
      "React",
      "SCSS",
      "Node.js",
  ...
  },
  {
    ...
    description:
      "An app for visualizing my bucket list trips with each destination including things to do.",
    technologies: ["React", "CSS", "React-Leaflet.js", "Leaflet.js"],
  },
  {
    ...
    description:
      "A tracker that provides information on the location, timezone, and ISP of an IP address.",
    technologies: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  },
  {
    ...
    description:
      "A quiz that fetches computer-based questions from a Trivia API.",
      ...
      return `<li class="project-item">
                    <div class="project-details">
                        ...
                        <div class="project-img">
                            <a href=${
                              project.link
                            } target="_blank" aria-describedby="new-tab">
        ...
        project.name
                    ...
                    <div class="project-description">
                        ...
                        <ul role="list" class="project-technologies-list">
                            ${project.technologies
                              .map((technology) => `<li>${technology}</li>`)
                              .join("")}
                        </ul>
                        <ul role="list" class="project-links-list">
                            <li>
                                <a href=${
                                  project.github
                                } target="_blank" aria-describedby="new-tab">
...
document.getElementById("main-projects-list").innerHTML = projectsHTML(
  "full-stack",
  projectDetails
);
document.getElementById("other-projects-list").innerHTML = projectsHTML(
  "other",
  projectDetails
);
